            ...
            <div class="col-md-12">
                <div class="navigation-root">
                    <ul class="navigation-list">
                        ...
                        <li class="navigation-item navigation-previous-item  navigation-active-item" id="secondst"><span>Hotel Information</span></li>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">	
                                ...
                                <div class="row">
                                            ...
                                            @if(Auth::user()->profile_id==0)
                                               ...
                                               <div class="text-area">
                                                	<div class="form-group">
                                                     <label for="opinion">ThermaEurope Opinion<span class="required">*</span></label>
                                                	<textarea class="form-control" name="opinion" id="opinion">{{(isset($hoteldetails->opinion)) ? $hoteldetails->name : old('opinion')}}</textarea>
                                                    	</div>
                                                </div>
                                                <div class="row">
                                                	<div class="col-md-6 col-sm-12 col-xs-12">

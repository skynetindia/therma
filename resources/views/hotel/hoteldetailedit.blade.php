...
@section('content')
            ...
            <div class="col-md-12">
                <div class="navigation-root">
                    <ul class="navigation-list">
                        ...
                        <li class="navigation-item navigation-previous-item  navigation-active-item" id="secondst">
                            <span>{{trans('messages.keyword_hotel_information')}}</span></li>
    ...
    <a href="{{ url('hotel/edit/billinginfo/')."/".$hoteldetails->id }}">@lang('messages.keyword_skip')</a>
                ...
                <div class="section-border">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="row hotel-information-head-blk ">
                                    <div class="col-md-5 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group" id="checkinfrom">
                                            ...
                                            @endphp
                                            <label for="checkinstart">{{trans('messages.keyword_from')}}
                                        ...
                                        <div class="form-group">
                                            <label for="checkinend">{{trans('messages.keyword_to')}}
                                                <span class="required">*</span></label>
                                    ...
                                    <div class="col-md-5 col-sm-12 col-xs-12">
                                        <p>Check-out</p>
                                        <div class="form-group">
                                            <label for="checkoutstart">{{trans('messages.keyword_from')}}
                                                <span class="required">*</span></label>
                                            <input type="text" name="checkout[]" id="checkoutstart" value="{{(isset($hoteldetails->check_out) && isset($checkout[0]) && $hoteldetails->check_out!='')?$checkin[0]:''}}" class="form-control timepicker" placeholder="{{trans('messages.keyword_from')}}">
                                        </div>
                                        <div class="form-group">
                                            <label for="checkoutend">{{trans('messages.keyword_to')}}
                                                <span class="required">*</span></label>
                            ...
                            @else
                                <div class="form-group">
                                    <label for="name">{{trans('messages.keyword_hotel_name')}}
                                        <span class="required">(*)</span></label>
                            ...
                            <div class="text-area">
                                <div class="form-group">
                                    <label for="opinion">@lang('messages.keyword_thermaeurope_opinion')
                                        <span class="required">*</span></label>
                            ...
                            <div class="ck-editor-abs">
                                ...
                                <label>{{trans('messages.keyword_description')}}
                                    <span class="required">(*)</span></label>
                            ...
                            <div class="btn-shape">
                                <div class="row">
                                    <div class="col-md-6 col-sm-12 col-xs-12 btn-left-shape text-left">
                                        <a href="{{url('hotel/edit/basic/'.$hoteldetails->id)}}" class="btn btn-default">{{trans('messages.keyword_previous')}}</a>
                                    </div>
                                    <div class="col-md-6 col-sm-12 col-xs-12 btn-right-shape text-right">
                                        <button type="submit" class="btn btn-default">{{trans('messages.keyword_next')}}</a>
                                    </div>
    ...
    <script>
            ...
            $(this).dropzone({
                complete: function (file) {
                    if (file.status == "success") {
                        $.ajax({
                            url: urlgetfile, success: function (result) {
                                sliderfun.destroy();
        ...
        function deleteMediaFile(id) {
            ...
            $.ajax({
                url: urlD, success: function (result) {

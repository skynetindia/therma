                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="" value="{{(isset($transfer->flight_time)) ? date('m/d/Y h:i:s A',strtotime($transfer->flight_time)) : ''}}" name="flight_time" id="flight_time" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="" value="{{(isset($transfer->pickup_time)) ? date('m/d/Y h:i:s A',strtotime($transfer->pickup_time)) : ''}}" name="pickup_time" id="pickup_time" type="text">
                                        </div>
                                    </div>

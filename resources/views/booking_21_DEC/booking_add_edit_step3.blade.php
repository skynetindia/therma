                                ...
                                @if(isset($bookingdetail->id))
                                   ...
                                   @endif         
                                    ...
                                    <div class="col-md-6">
                                     ...
                                     <div class="col-md-6">
                                         <div class="form-group">
                                             <label for="">@lang('messages.keyword_payment_type') <span class="required">(*)</span></label>
                                             <select name="is_payment_online" id="" class="form-control">
                                                 <option value="">@lang('messages.keyword_--select--')</option>
                                                 <option value="1">@lang('messages.keyword_online')</option>
                                                 <option value="0">@lang('messages.keyword_cash')</option>
                                             </select>
                                         </div>
                                     </div>

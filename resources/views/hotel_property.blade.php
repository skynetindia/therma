		...
		<div class="table-responsive">
            ...
            <table data-toggle="table" data-search="true" data-pagination="true" data-id-field="id" data-show-refresh="true"  data-show-columns="true" data-url="<?php  echo url('hotel/property/json');?>" data-classes="table table-bordered" id="table">
                <thead>
                    ...
                    <th data-field="location_priority" data-sortable="true">{{trans('messages.keyword_priority_for_locations')}}</th>
                    <th data-field="email" data-sortable="true">{{trans('messages.keyword_email')}}</th>
                    <th data-field="commissions" data-sortable="true">{{trans('messages.keyword_commission_hotel')}}</th>
                    <th data-field="treatment_commission" data-sortable="true">{{trans('messages.keyword_commission_treatment')}}</th>
                    @if(Auth::user()->profile_id != '1' )
                    <th data-field="access_user" data-sortable="true">{{trans('messages.keyword_access')}}</th>
                    @endif

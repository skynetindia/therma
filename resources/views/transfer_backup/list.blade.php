                                                ...
                                                <div class="reservation-list-widthcalc">
                                                    ...
                                                    <div class="input form-group">
                                                        <div class="date-input ">
                                                            ...
                                                            <input type="text" id="start_date" value="{{ old('start_date') }}" name="arrival" placeholder="dd/mm/yyyy" class="form-control datepicker" readonly/>
                                                        </div>
                                                        <div>-</div>
                                                        <div class="date-input">
                                                            <label>@lang('messages.keyword_end_date')</label>
                                                            <input type="text" id="end_date" value="{{ old('end_date') }}" placeholder="dd/mm/yyyy" name="departure"

                    ...
                    <div class="basic-info-lft">
                        <div class="basic-data-blk">
                            <div class="section-border">
                                ...
                                function customers($bookingdetail)
                                {
								  ...
								  $childage=json_decode($bookingdetail->childage,true);
								   foreach($childage as $ckey=>$cval):
								  	$child['type']='child';
									$child['name']='Child Age '.$cval;
									$customer[]=$child;
								  endforeach; 
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        @foreach(customers($bookingdetail) as $customer)
                                                    ...
                                                    <div class="panel panel-default">
                                                        ...
                                                        <div class="panel-body">
                                                            <div class="media">
                                                                ...
                                                                <div class="media-right">
                                                                    <button type="button" class="btn btn-primary package_{{ $package->id }}_{{ $customer['name'] }}" data-price="{{ $package->price }}" data-name="{{ $customer['name'] }}" data-package="{{ $package->id }}" data-class="package_{{ $package->id }}" onclick="addRemoveToggle(this)"><i class="fa fa-hand-pointer-o"></i> Select Package</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>

...
@section('content')
    ...
    @php
        $inputReadyOnlyOnReadPermission = (checkpermission($module_id,$parent_id, 1) == false) ? 'readonly' : '';
    @endphp
                        ...
                        @if(checkpermission($module_id,$parent_id, 1))
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="ryt-chk">
                                        <input id="chktasmealsall" name="chktasmealsall" type="checkbox"><label for="chktasmealsall">select all</label>
                                    </div>
                                </div>
                            ...
                            <table class="table table-striped table-bordered checkbox-tbl">
                                @foreach($taxinomies_meals as $types)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input type="text" {{ $inputReadyOnlyOnReadPermission }} class="form-control" name="code[{{$types->id}}]" value="{{$types->code}}"/>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <input type="text" {{ $inputReadyOnlyOnReadPermission }} class="form-control" name="price[{{$types->id}}]" value="{{$types->price}}"/>
                                            </div>
                                        </td>
                                        @if(checkpermission($module_id,$parent_id, 1))
                                            <td>
                        ...
                        <form action="{{url('/taxonomies/mealscombination/savenew')}}" method="post" id="frmmealsadd" name="frmmealsadd">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <input class="form-control" {{ $inputReadyOnlyOnReadPermission }} type="text" name="name" placeholder="{{trans('messages.keyword_name')}}" required>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <select id="mealid" {{ $inputReadyOnlyOnReadPermission }} name="mealscombination[]" class="js_selecttwo_multiple form-control" multiple="multiple">
                    ...
                    <div class="select-all">
                        @if(checkpermission($module_id,$parent_id, 1))
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="ryt-chk">
                                        <input id="chktasmealscombinationall" name="chktasmealscombinationall" type="checkbox"><label for="chktasmealscombinationall">select all</label>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-12 text-right">
                                ...
                                @foreach($taxinomies_meals_combination as $types)
                                    ...
                                    <tr>
                                        @if(checkpermission($module_id,$parent_id, 1))
                                            <td>
                                                <div class="ryt-chk">
                                                    <input class="chkmealscombination" {{ $inputReadyOnlyOnReadPermission }} type="checkbox" name="chkmealscombination[{{$types->id}}]" id="chkmealscombination_{{$types->id}}" value="{{$types->id}}">
                                        ...
                                        <td>
                                            <div class="form-group"><?php
                                                ...
                                                ?>
                                                <select id="mealid" {{ $inputReadyOnlyOnReadPermission }} name="mealscombination[{{$types->id}}][]" class="js_selecttwo_multiple form-control" multiple="multiple">
                                                    @foreach($taxinomies_meals as $meals)
                    ...
                    <div class="select-all">
                        @if(checkpermission($module_id,$parent_id, 1))
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="ryt-chk">
                                        <input id="chktasroomtypeall" name="chktasroomtypeall" type="checkbox"><label for="chktasroomtypeall">select all</label>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-12 text-right">
                    ...
                    <div class="select-all">
                        @if(checkpermission($module_id,$parent_id, 1))
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="ryt-chk">
                                        <input id="chktasroombedall"  name="chktasroombedall" type="checkbox"><label for="chktasroombedall">select all</label>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-12 text-right">

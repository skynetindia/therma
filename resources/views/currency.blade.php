...
@section('content')
                    ...
                    <div class="data-table">
                        <div class="table-responsive">
                            ...
                            <table data-toggle="table" data-search="true" data-pagination="true" data-id-field="id" data-show-refresh="true" data-show-columns="true" data-url="currency/json" data-classes="table table-bordered" id="table">
                                ...
                                <th data-field="suffix" data-sortable="true">{{trans('messages.keyword_suffix')}}</th>
                                <th data-field="prefix" data-sortable="true">{{trans('messages.keyword_prefix')}}</th>
                                <th data-field="exchange_rate" data-sortable="true">{{trans('messages.keyword_exchange_rate')}}</th>
                                <th data-field="status" data-sortable="true">{{trans('messages.keyword_default_language')}}</th>
                                </thead>
                            </table>
                        </div>
                    </div>
    ...
    <script>
        ...
        function check() {
            return confirm("{{trans('messages.keyword_are_you_sure_you_want_to_delete:')}} " + n + " {{trans('messages.keyword_currency')}}?");
        }

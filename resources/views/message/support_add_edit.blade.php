...
@section('content')
    ...
    {{ Form::open(array('url' => '/message/support/update', 'files' => true, 'id' => 'ticket_edit_form')) }}
    ...
    <div class="message-wrap ticket-wrap">
        ...
        <div class="section-border">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12 col-xs-12">
                    <div class="form-group">
                        <label for="" class="block">@lang('messages.keyword_status')</label>
                        <?php $checked =  (isset($support->is_active) && $support->is_active == '0') ? 'checked' : '' ?>
                        <div class="switch"><input value="1"  onchange="updateSupportStatus({{ $support->id }})" name="is_active" id="activestatus_{{ $support->id }}" type="checkbox" {{ $checked }}><label
                                    for="activestatus_{{ $support->id }}"></label></div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        $( "#ticket_edit_form" ).validate({
            ...
            messages: {
                description: {
                    required: "@lang('messages.keyword_please_enter_description')"
                }
            }
        });

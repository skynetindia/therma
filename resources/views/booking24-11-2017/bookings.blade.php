    ...
    <div class="booking-wrap reservations-list">
        ...
        <div class="row">
            <div class="col-md-12 col-sm1-12 col-xs-12">
                <div class="table-btn">
                    <a href="#" class="btn btn-add"><i class="fa fa-plus"></i></a>
                    <a href="#" class="btn btn-edit"><i class="fa fa-pencil-square-o"
                                                        aria-hidden="true"></i></a>
                    <a href="#" class="btn btn-delete"><i class="fa fa-trash"></i></a>
                    <!-- <a href="media.html" class="btn btn-edit"><i class="fa fa-camera" aria-hidden="true"></i></a>-->
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div id="getNotes"></div>
                <hr>
                <textarea name="description" id="description" cols="30" rows="1" style="resize: vertical;" class="form-control"></textarea>
            </div>

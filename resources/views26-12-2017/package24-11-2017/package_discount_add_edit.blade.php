                        ...
                        <div class="user-form row">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="tax_discount_id">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="" name="days_before_arrival"
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    <label for="">@lang('messages.keyword_apply_the_discount') <span class="required">(*)</span></label>
                                    <select class="form-control" name="apply_the_discount">
                                        <option value="">@lang('messages.keyword_--select--')</option>
                                        <option value="1" {{ (isset($discount->apply_the_discount) && $discount->apply_the_discount == "1") ? 'selected' : '' }}>The discount will be calculated for the entire stay, and
                                            the entire stay must be in the period of the discount
                                        </option>
                                        <option value="2" {{ (isset($discount->apply_the_discount) && $discount->apply_the_discount == "2") ? 'selected' : '' }}>The discount will be calculated for the entire stay,
                                            although the discount period will only partially be valid
                                        </option>
                                        <option value="3" {{ (isset($discount->apply_the_discount) && $discount->apply_the_discount == "3") ? 'selected' : '' }}>The discount will be calculated only on those nights
                                            that fall on the date of the discount
                                        </option>
                                    </select>
                                </div>

                                <div class="form-group">
                                    <label for="">@lang('messages.keyword_rooms')</label>
                                </div>
                                <?php

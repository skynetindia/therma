...
@section('content')
    ...
    <div class="ssetting-wrap">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="table-btn">
                    <a href="{{ url('/menu/edit/') }}" class="btn btn-add"><i class="fa fa-plus"></i></a>
    ...
    <script>
        ...
        function check() {
            return confirm("{{trans('messages.keyword_are_you_sure_want_to_delete_menu')}}");
        }

...
@section('content')
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="table-btn">
                    ...
                    <a href="javascript:void(0);" onclick="multipleAction('copy');" class="btn btn-edit"><i
                    ...
                    <div class="data-table">
                        <div class="table-responsive">
                            ...
                            <table data-toggle="table" data-search="true" data-pagination="true" data-id-field="id"
                                ...
                                <th data-field="rooms" data-sortable="true">{{trans('messages.keyword_rooms')}}</th>
    ...
    <script type="application/javascript">
        ...
        function updatePackageDiscountStatus(id) {
            var url = "{{ url('/package/discount/changeactivestatus') }}"  + '/';
            var status = '1';
        ...
        function check() {
            return confirm("{{trans('messages.keyword_are_you_sure_want_to_remove_discount')}}");
        }
        ...
        function multipleAction(act) {
            ...
            switch (act) {
                case 'delete':
                    link.href = "{{ url('package/discount/delete') }}" + '/';
                    if (check() && n != 0) {
                        //for(var i = 0; i < n; i++) {
                        $.ajax({
                            type: "GET",
                            ...
                            error: function (url) {
                                if (url.status == 403) {
                                    link.href = "{{ url('/package/discount/delete') }}" + '/' + indici[n];

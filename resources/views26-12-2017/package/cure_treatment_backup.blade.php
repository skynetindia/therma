                        ...
                        <div class="data-table">
                            <div class="table-responsive">
                                ...
                                <table data-toggle="table" data-search="true" data-pagination="true" data-id-field="id"
                                       data-show-refresh="true" data-detail-view="true" data-detail-formatter="detailFormatter" data-show-columns="true"
                                       data-url="{{ url('package/cure-treatment/property/json/0') }}"
                        ...
                        <div class="data-table">
                            <div class="table-responsive">
                                ...
                                <table data-toggle="table" data-search="true" data-pagination="true" data-id-field="id"
                                       ...
                                       data-url="{{ url('package/cure-treatment/property/json/1') }}"
                                       data-classes="table table-bordered" class="table">
                                    <thead>
                                    <th data-field="id" data-sortable="true">{{trans('messages.keyword_id')}}</th>
                                    <th data-field="name" data-sortable="true">{{trans('messages.keyword_name')}}</th>

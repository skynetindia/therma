...
@section('content')
                    ...
                    <div class="select-all">
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-12"><div class="ryt-chk">
                                    <input id="chktaspaymentall" name="chktaspaymentall" type="checkbox"><label for="chktaspaymentall">@lang('messages.keyword_select_all')</label></div></div>
                            ...
                            <table class="table table-striped table-bordered checkbox-tbl">
                                @foreach($taxinomies_payment as $types)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="{{trans('messages.keyword_description')}}" name="description[{{$types->id}}]" id="description" value="<?php echo $types->description; ?>"/>
                                            </div>
                                        </td>
    ...
    <script type="text/javascript">
        function conferma(e) {
            var confirmation = confirm("<?php echo trans('messages.keyword_are_you_sure_want_to_remove_selected_payments');?>") ;
            if (!confirmation)
                e.preventDefault();
            return confirmation ;
        }

                     ...
                     <div class="select-all">
                      <div class="row">
                          <div class="col-md-6 col-sm-6 col-xs-12"><div class="ryt-chk">
                            <input id="chktasemotionalstatusall" name="chktasemotionalstatusall" type="checkbox"><label for="chktasemotionalstatusall">select all</label></div></div>
         ...
         <div class="section-border">   
         		<div class="row">                          
                     ...
                     <div class="select-all">
                     	<div class="row">
                        	<div class="col-md-6 col-sm-6 col-xs-12"><div class="ryt-chk">
                            <input id="chktascreditcardall" name="chktascreditcardall" type="checkbox"><label for="chktascreditcardall">select all</label></div></div>
                            <div class="col-md-6 col-sm-6 col-xs-12 text-right">
         ...
         <div class="section-border">   
         		<div class="row">                          
                     ...
                     <div class="select-all">
                     	<div class="row">
                        	<div class="col-md-6 col-sm-6 col-xs-12"><div class="ryt-chk">
                            <input id="chktasvatinvoiceall" name="chktasvatinvoiceall" type="checkbox"><label for="chktasvatinvoiceall">select all</label></div></div>
                            <div class="col-md-6 col-sm-6 col-xs-12 text-right">
         ...
         <div class="section-border">   
            <div class="row">                          
                     ...
                     <div class="select-all">
                      <div class="row">
                          <div class="col-md-6 col-sm-6 col-xs-12"><div class="ryt-chk">
                            <input id="chktasagetypeall" name="chktasagetypeall" type="checkbox"><label for="chktasagetypeall">select all</label></div></div>
                            <div class="col-md-6 col-sm-6 col-xs-12 text-right">
                     ...
                     @foreach($taxinomies_age_type as $types)
                      ...
                      <input type="hidden" name="id[]" value="{{$types->id}}">            
                        <tr>
                            ...
                            <td>
                              <div class="form-group">
                                  <input type="text" class="form-control" name="age[{{$types->id}}]" value="{{$types->age}}"/>
                                </div>
                            </td>
                            <td>

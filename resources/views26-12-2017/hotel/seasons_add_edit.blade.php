                    ...
                    <div class="user-form row">
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group select-container">
                                ...
                                <select name="category[]" class="form-control select2" id="category" multiple="multiple">
                            ...
                            <div class="form-group select-container">
                                ...
                                ?>
                                <select name="hotel_id" class="form-control select2" id="hotel_id">                                    
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="season_from" value="{{ isset($seasonDetails->season_from) ? dateFormate($seasonDetails->season_from,'d-m-Y') : ''}}" class="form-control startdate" id="season_from" placeholder="{{trans('messages.keyword_from')}}">
                            </div>
                            <div class="form-group">
                                <label for="">{{trans('messages.keyword_to')}} <span class="required">(*)</span></label>
                                <input type="text" name="season_to" value="{{ isset($seasonDetails->season_to) ?  dateFormate($seasonDetails->season_to,'d-m-Y') : '' }}" class="form-control enddate" id="season_to" placeholder="{{trans('messages.keyword_to')}}">
                            </div>
                        </div>
                    </div><hr>
                </div>

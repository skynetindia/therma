            ...
            <div class="col-md-12">
                <div class="navigation-root">
                    <ul class="navigation-list">
                        <li class="navigation-item navigation-previous-item  navigation-active-item" id="firstst"><span>{{trans('messages.keyword_basic_information')}}</span></li>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <label for="city_tax">{{trans('messages.keyword_priority')}}</label>
                                            <input class="form-control" id="priority" name="priority" value="{{(isset($hoteldetails->priority)) ? $hoteldetails->priority : old('priority')}}" placeholder="{{trans('messages.keyword_priority')}}" type="number">
                                        </div>
                                    </div>                                    
                                    <div class="col-md-4 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <label for="currency">{{trans('messages.keyword_currency')}}</label>
                                            <select class="form-control" id="currency" name="currency">
                                            <option value=""></option>
                                            @foreach($currency as $curkey=>$curval)
                                             <option value="{{$curval->id}}" {{(isset($hoteldetails->currency) && $hoteldetails->currency==$curval->id) ? 'selected' : ''}}>{{$curval->code}}</option>
                                             @endforeach
                                             </select>
                                        </div>
                                         <div class="row">
        ...
        $(document).ready(function () {
          ...
          $("#frmHotelDetailInfo").validate({
                ...
                messages: {
					...
					hotel_category:"@lang('messages.keyword_please_select_category')",
					treatment_commission:{
						max:"@lang('messages.keyword_please_enter_value_less_than_100')"
					},
					priority:{

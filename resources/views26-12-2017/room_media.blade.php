...
<script type="text/javascript" src="{{asset('public/js/dropzone.js')}}"></script>
    ...
    @include('common.errors')
        ...
        <div class="media-wrap">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <input type="hidden" name="mediaCode" id="mediaCode" value="{{$mediaCode}}" />
                     <div class="upload-file-form col-md-12 col-sm-12 col-xs-12">
                        ...
                        {{ csrf_field() }}
                        <input type="hidden" name="master_id" value="{{ $roomdetail->id }}">
                        </form>             
                    </div>
            ...
            <div class="btn-shape">
                <div class="row">
                    <div class="col-md-6 col-sm-12 col-xs-12 btn-left-shape text-left"><a href="{{ url('hotel/room/amenities').'/'.$roomid }}" class="btn btn-default">@lang('messages.keyword_previous')</a></div>
                    <div class="col-md-6 col-sm-12 col-xs-12 btn-right-shape text-right"><a href="{{ url('hotel/room/room-details') }}" class="btn btn-default">@lang('messages.keyword_save')</a></div>
                </div>
            </div>
        </div>
 ...
 <script>
    ...
    function deleteMediaFile(id){
        var urlD = '<?php echo url('/room/media/deletefiles/'); ?>/'+id;
      ...
      $('#commnetform').on('submit',function(e){
            ...
            e.preventDefault(e);
                $.ajax({
                type:"POST",
                url:'{{ url('/room/media/comment/').'/'.$mediaCode }}',
                data:$(this).serialize(),
                //dataType: 'json',
    ...
    <div class="modal-dialog modal-l">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ url('/room/media/comment/').'/'.$mediaCode }}" name="commnetform" method="post" id="commnetform">
                    {{ csrf_field() }}
                    @include('common.errors')                       
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">                               
                    ...
                    <div class="modal-footer">
                        <input type="submit" class="btn btn-default btn-6-12" value="{{ trans('messages.keyword_save') }} ">
                    </div>
                </form>

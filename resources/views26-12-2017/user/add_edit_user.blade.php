                    ...
                    <div class="user-form row">
                        ...
                        <div class="col-md-4 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{ isset($user->name) ? $user->name : '' }}"  class="form-control" id="name" placeholder="Enter name">
                            </div>

                            <div class="form-group form-control-file">
                                <label for="">@lang('messages.keyword_select_image')</label>
                                <input type="hidden" name="old_image" value="{{ isset($user->image) ? $user->image : '' }}" id="old_image">
                        ...
                        <div class="col-md-4 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="email" name="email" value="{{ isset($user->email) ? $user->email : '' }}"  class="form-control" id="email" placeholder="example@email.com">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" value="{{ isset($user->password) ? $user->password : '' }}"  class="form-control" id="password" placeholder="**********">
                            </div>
                            @endif
                        ...
                        <div class="col-md-4 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <input class="form-control addressautocomplete gm-err-autocomplete" value="{{ isset($user->address) ? $user->address : '' }}" id="placeaddress" placeholder="{{trans('messages.keyword_address')}}" name="address" type="text">

...
<link href="//cdn.datatables.net/1.10.15/css/dataTables.bootstrap.min.css" rel="stylesheet">
  ...
  <link rel="stylesheet" href="{{asset('public/jqueryui/jquery-ui.css')}}">
  <script src="{{asset('public/jqueryui/jquery-ui.js')}}"></script>
...
$(function(){
			...
			$('.datepicker').bootstrapDP();
			 $(".startdate").bootstrapDP({
					...
					$('.enddate').bootstrapDP('setStartDate', minDate);
				});
			
			$(".enddate").bootstrapDP({autoclose:true})
				.on('changeDate', function (selected) {
					var maxDate = new Date(selected.date.valueOf());
					$('.startdate').bootstrapDP('setEndDate', maxDate);
			});
 });

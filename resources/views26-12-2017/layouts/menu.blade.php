                                        ...
                                        <ul class="nav navbar-nav">
                                            @if(count(fetPrimaryDynamicMenu()) > 0)
                                               @foreach(fetPrimaryDynamicMenu() as $primary_dynamic_menu)
                                                    ...
                                                    <li><a href="{{ url($primary_dynamic_menu->link) }}" class="{{ ($primary_dynamic_menu->menu_class) ? $primary_dynamic_menu->menu_class : '' }}"><img src="{{ asset('public/images/dynamic_menu')."/".$primary_dynamic_menu->image }}" alt="{{ $primary_dynamic_menu->name }}"/><p>{{ $primary_dynamic_menu->name }}</p></a></li>
                                                @endforeach
                                            @endif

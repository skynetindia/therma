                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table">
                        <div class="table-responsive">
                            <h1 class="cst-datatable-heading">My Tickets</h1>
                            <table data-toggle="table" data-search="true" data-pagination="true" data-id-field="id"
                                   data-show-refresh="true" data-show-columns="true"
                                   data-url="{{ url('mytickets/get/json')."/".Auth::user()->id }}"
                                ...
                                <th data-field="updated_at" data-sortable="true">{{trans('messages.keyword_updated_at')}}</th>
                                </thead>
                            </table>
                        </div>
                    </div>
        ...
        function multipleAction(act) {
            ...
            switch (act) {
                ...
                case 'modify':
                    if (n != 0) {
                        n--;
                        link.href = "{{ url('myticket/edit') }}" + '/' + indici[n];
                        n = 0;
                        selezione = undefined;
                        link.dispatchEvent(clickEvent);
                    }

                                                ...
                                                <div class="reservation-list-widthcalc">
                                                    ...
                                                    <div class="input form-group">
                                                        <div class="date-input ">
                                                            ...
                                                            <input type="text" id="arrival" value="{{ (isset($oldform_data['arrival'])) ? $oldform_data['arrival'] : old('arrival') }}" name="arrival" placeholder="mm/dd/yyyy" class="form-control startdate"/>
                                                        </div>
                                                        <div>-</div>
                                                        <div class="date-input">
                                                            <label>@lang('messages.keyword_end_date')</label>
                                                            <input type="text" id="end_date" value="{{ (isset($oldform_data['departure'])) ? $oldform_data['departure'] : old('departure') }}" placeholder="mm/dd/yyyy" name="departure" class="form-control enddate"/>
                                                        </div>
                                                    </div>
                                        ...
                                        <table data-toggle="table" data-search="true" data-pagination="true" data-id-field="id"
                                            ...
                                            @foreach($filtered_transfer as $transfer)
                                                <tr>
                                                    ...
                                                    <td>{{ toUcWord($transfer->client_name) }}</td>
                                                    <td>{{ $transfer->client_phone }}</td>
                                                    <td>{{ ($transfer->direction == '1') ? ucwords(trans('messages.keyword_arrival')) : ucwords(trans('messages.keyword_departure'))}}</td>
                                                    <td>{{ ($transfer->type == '1') ? ucwords(trans('messages.keyword_group')) : ucwords(trans('messages.keyword_individual')) }}</td>
                                                    <td>{{ $transfer->pax }}</td>
                                                    <td>{{ $transfer->start }}</td>
                                                    <td>{{ $transfer->destination }}</td>
                                                    <td>{{ \Carbon\Carbon::parse($transfer->flight_time)->format('d/m/y H:i A') }}</td>
                                                    <td>{{ $transfer->flight }}</td>
                                                    <td>{{ \Carbon\Carbon::parse($transfer->pickup_time)->format('d/m/y H:i A') }}</td>
    ...
    <script>
        ...
        function checkNotEmptyReservations(e)
        {
            ...
            if(checkedLength == '0')
            {
                ...
                transfer_confirm(checkedLength);
            }
        }
